...
const Alert = () => {
    ...
    return (
        <div id="alertContainer" className="alert fixed bottom-4 right-4 text-sm min-w-[20rem] backdrop-blur-xl p-3 pl-4 pr-4 border-1 border-border rounded-md bg-fgLight/70 translate-x-[120%] transition-all duration-500 z-30">
